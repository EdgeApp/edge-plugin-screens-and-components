...
var powerThemes = function powerThemes(theme) {
  return {
    container: {
      display: 'flex',
      flex: 1
...
var PoweredBy = withStyles$1(powerThemes)(function (props) {
  ...
  var logoWrap = props.poweredBy.useBackground ? props.classes.logoWrapper : props.classes.logoWrapperClear;
...
var Typography$1 = withStyles$1(styles$3, {
  name: 'MuiTypography',
  withTheme: true
})(Typography);

var StartHeader = function StartHeader(props) {
...
var StartParagraph = function StartParagraph(props) {
  return React__default.createElement(Typography$1, {
    component: "p",
    className: props.classes.p
  }, props.children);
};
...
var Divider$1 = withStyles$1(styles$4, {
  name: 'MuiDivider'
})(Divider);

var renderListItems = function renderListItems(list) {
  var items = list.map(function (item) {
    return React__default.createElement("li", null, item);
  });
  return items;
};

var renderList = function renderList(tempList, classes) {
  console.log(tempList);
  if (!tempList) return null;
  if (tempList.length < 1) return null;
  return React__default.createElement("ul", {
    className: classes.feeList
  }, renderListItems(tempList));
};

var renderDivider = function renderDivider(removeDivider, classes) {
  if (removeDivider) return null;
  return React__default.createElement(Divider$1, {
    className: classes.divider
  });
};

var IntroItem = function IntroItem(props) {
  return React__default.createElement(React.Fragment, null, React__default.createElement("div", null, React__default.createElement(StartHeader, {
    text: props.card.title,
    classes: props.classes
  }), React__default.createElement(StartParagraph, {
    classes: props.classes
  }, props.card.body), renderList(props.card.list, props.classes)), renderDivider(props.removeDivider, props.classes));
};
...
var IntroItemComponent = withStyles$1(styles$5)(IntroItem);
...
var InputBase$1 = withStyles$1(styles$7, {
  name: 'MuiInputBase'
})(InputBase);
...
Input.muiName = 'Input';
var Input$1 = withStyles$1(styles$8, {
  name: 'MuiInput'
})(Input);
...
var FilledInput$1 = withStyles$1(styles$9, {
  name: 'MuiFilledInput'
})(FilledInput);
...
var NotchedOutline = React__default.forwardRef(function NotchedOutline(props, ref) {
  ...
  return React__default.createElement("fieldset", _extends$1({
    "aria-hidden": true,
    style: _extends$1(_defineProperty$1({}, "padding".concat(capitalize(align)), 8 + (notched ? 0 : labelWidth / 2)), style),
    className: clsx(classes.root, className),
    ref: ref
...
var NotchedOutline$1 = withStyles$1(styles$a, {
...
var OutlinedInput$1 = withStyles$1(styles$b, {
...
var FormLabel$1 = withStyles$1(styles$c, {
  name: 'MuiFormLabel'
})(FormLabel);
...
var InputLabel = React__default.forwardRef(function InputLabel(props, ref) {
  ...
  return React__default.createElement(FormLabel$1, _extends$1({
    "data-shrink": shrink,
...
var InputLabel$1 = withStyles$1(styles$d, {
  name: 'MuiInputLabel'
})(InputLabel);
  ...
  if (process.env.NODE_ENV !== 'production') {
    ...
    registerEffect = function registerEffect() {
      if (registeredInput.current) {
        process.env.NODE_ENV !== "production" ? warning_1(false, ['Material-UI: there are multiple InputBase components inside a FromControl.', 'This is not supported. It might cause infinite rendering loops.', 'Only use one InputBase.'].join('\n')) : void 0;
      }
...
var FormControl$1 = withStyles$1(styles$e, {
  name: 'MuiFormControl'
})(FormControl);
...
var FormHelperText$1 = withStyles$1(styles$f, {
...
var SimpleBackdrop = React__default.forwardRef(function SimpleBackdrop(props, ref) {
  ...
  return open ? React__default.createElement("div", _extends$1({
    "aria-hidden": true,
    ref: ref
  }, other, {
    style: _extends$1({}, styles$g.root, {}, invisible ? styles$g.invisible : {}, {}, other.style)
  })) : null;
});
...
var Modal = React__default.forwardRef(function Modal(props, ref) {
  ...
  }), hideBackdrop ? null : React__default.createElement(BackdropComponent, _extends$1({
    open: open,
...
var Grow = React__default.forwardRef(function Grow(props, ref) {
  ...
  return React__default.createElement(Transition, _extends$1({
    appear: true,
    in: inProp,
    onEnter: handleEnter,
    onExit: handleExit,
    ...
    return React__default.cloneElement(children, _extends$1({
      style: _extends$1({
        opacity: 0,
        transform: getScale(0.75),
        visibility: state === 'exited' && !inProp ? 'hidden' : undefined
      }, styles$i[state], {}, style, {}, children.props.style),
      ref: handleRef
    }, childProps));
  });
});
...
var Paper$1 = withStyles$1(styles$j, {
  name: 'MuiPaper'
})(Paper);
...
var Popover = React__default.forwardRef(function Popover(props, ref) {
  ...
  return React__default.createElement(Modal, _extends$1({
  ...
  }, other), React__default.createElement(TransitionComponent, _extends$1({
    appear: true,
    in: open,
    onEnter: onEnter,
    onEntered: onEntered,
  ...
  }), React__default.createElement(Paper$1, _extends$1({
    elevation: elevation,
    ref: handlePaperRef
  }, PaperProps, {
...
var MenuList = React__default.forwardRef(function MenuList(props, ref) {
  ...
  return React__default.createElement(List$1, _extends$1({
    role: "menu",
    ref: handleRef,
    className: className,
    onKeyDown: handleKeyDown,
...
var Menu = React__default.forwardRef(function Menu(props, ref) {
  ...
  return React__default.createElement(Popover$1, _extends$1({
  ...
  }, other), React__default.createElement(MenuList, _extends$1({
...
var Menu$1 = withStyles$1(styles$m, {
  name: 'MuiMenu',
  withTheme: true
})(Menu);
...
var SelectInput = React__default.forwardRef(function SelectInput(props, ref) {
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement("div", _extends$1({
  ...
  }) : display), React__default.createElement("input", _extends$1({
  ...
  }), React__default.createElement(Menu$1, _extends$1({
    id: "menu-".concat(name || ''),
...
var SvgIcon$1 = withStyles$1(styles$n, {
  name: 'MuiSvgIcon'
})(SvgIcon);
...
var NativeSelectInput = React__default.forwardRef(function NativeSelectInput(props, ref) {
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement("select", _extends$1({
    className: clsx(classes.root, // TODO v5: merge root and select
...
var NativeSelect = React__default.forwardRef(function NativeSelect(props, ref) {
  ...
  return React__default.cloneElement(input, _extends$1({
...
var TextField = React__default.forwardRef(function TextField(props, ref) {
  ...
  var InputElement = React__default.createElement(InputComponent, _extends$1({
  ...
  return React__default.createElement(FormControl$1, _extends$1({
    ...
    required: required,
    variant: variant
  }, other), label && React__default.createElement(InputLabel$1, _extends$1({
    htmlFor: id,
    ref: labelRef
  }, InputLabelProps), label), select ? React__default.createElement(Select$1, _extends$1({
    "aria-describedby": helperTextId,
    value: value,
    input: InputElement
  }, SelectProps), children) : InputElement, helperText && React__default.createElement(FormHelperText$1, _extends$1({
    id: helperTextId
...
var BankAccountInfoSceneMinComponent =
/*#__PURE__*/
function (_Component) {
  _inheritsLoose(BankAccountInfoSceneMinComponent, _Component);

  function BankAccountInfoSceneMinComponent(props) {
    var _this;
    ...
    _defineProperty(_assertThisInitialized(_this), "changeSwift", function (event) {
      _this.setState({
  ...
  var _proto = BankAccountInfoSceneMinComponent.prototype;
...
var BankAccountInfoSceneMin = withStyles$1(styles$r)(BankAccountInfoSceneMinComponent);
...
var ChooseWalletButton$1 = withStyles(styles$s)(ChooseWalletButton);
...
var BuySellScene = withStyles$1(styles$t)(BuySellSceneComponent);

var IntroSceneComponent =
/*#__PURE__*/
function (_Component) {
  _inheritsLoose(IntroSceneComponent, _Component);

  function IntroSceneComponent() {
    var _this;
    ...
    _defineProperty(_assertThisInitialized(_this), "renderCards", function () {
      ...
      var cards = _this.props.cards.map(function (card) {
        counter++;
        return React__default.createElement(IntroItemComponent, {
          card: card,
          key: counter,
          removeDivider: counter === _this.props.cards.length
        });
      });
  ...
  var _proto = IntroSceneComponent.prototype;
  ...
  _proto.render = function render() {
    ...
    return React__default.createElement("div", {
      ...
      src: this.props.logo,
      alt: ''
    })), this.renderCards()), React__default.createElement("div", {
      className: classes.containerBottom
    }, React__default.createElement(PrimaryButton, {
      onClick: this.onNext
    }, "Next ")));
  ...
  return IntroSceneComponent;
}(React.Component);

var styles$u = function styles(theme) {
  return {
    container: _extends({}, sceneContainerNoHeight, {
      backgroundColor: THEME.COLORS.WHITE
    }),
    poweredByRow: poweredByRow,
    containerMain: sceneMainContainer,
    containerBottom: _extends({}, sceneButtonBottom, {
      marginTop: 40
    }),
    logoContainer: {
      display: 'flex',
...
var IntroScene = withStyles$1(styles$u)(IntroSceneComponent);
...
var CircularProgress$1 = withStyles$1(styles$v, {
...
/*#__PURE__*/
function (_Component) {
  _inheritsLoose(TransactionAmountScreenComponent, _Component);

  function TransactionAmountScreenComponent(props) {
    var _this;
    ...
    _defineProperty(_assertThisInitialized(_this), "renderInvisible", function () {
      var classes = _this.props.classes;
  ...
  var _proto = TransactionAmountScreenComponent.prototype;
...
var TransactionAmountScreen = withStyles$1(styles$w)(TransactionAmountScreenComponent);
...
var TransactionConfirmationScreen = withStyles$1(styles$x)(TransactionConfirmationScreenComponent);
...
var TransactionSuccess = withStyles$1(styles$y)(TransactionSuccessComponent);

exports.BankAccountInfoSceneMin = BankAccountInfoSceneMin;
