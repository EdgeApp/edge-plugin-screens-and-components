...
class NewUserNameSceneComponent extends Component<Props, State> {
  onNext = () => {
...
const NewUserNameScene = withStyles(styles)(NewUserNameSceneComponent)
export { NewUserNameScene }
